...
class Show(db.Model):
  ...
  id = db.Column(db.Integer, primary_key=True)
  artist_id = db.Column(db.String(3))
  venue_id = db.Column(db.String(3))
...
def create_venue_submission():
    ...
    try:
        ...
        image_link = request.form.get('name')
...
def edit_artist_submission(artist_id):
    ...
    try:
        ...
        artist_update = Artist.query.filter_by(id=artist_id).update(dict(name=name, city=city, state=state, phone=phone, genres=genres,
                        image_link=image_link, facebook_link=facebook_link, website_link=website_link,
                        seeking_venue=seeking_venue, seeking_description=seeking_description))
        db.session.commit()
...
def create_show_submission():
    ...
    try:
        ...
        artist = Show(artist_id=artist_id, venue_id=venue_id)
        db.session.add(artist)
        db.session.commit()
